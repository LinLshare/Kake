...
import com.theta360.v2.view.ImageListArrayAdapter;
import com.theta360.v2.view.ImageRow;
import com.theta360.v2.view.ImageSizeDialog;
import com.theta360.v2.view.LogView;
...
public class ImageListActivity extends Activity implements ImageSizeDialog.DialogBtnListener {
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    Switch connectionSwitch = (Switch) menu.findItem(R.id.connection)
                                           .getActionView()
                                           .findViewById(R.id.connection_switch);
    connectionSwitch.setOnCheckedChangeListener(new OnCheckedChangeListener() {
      ...
      public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        ImageListArrayAdapter empty = new ImageListArrayAdapter(ImageListActivity.this,
                                                                R.layout.listlayout_object,
                                                                new ArrayList<ImageRow>());
