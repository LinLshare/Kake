package com.home77.kake.business.home.view.glview;
...
public class GLRenderer implements Renderer {
   ...
   *
   * @param xz
   *     X axis direction rotation value
   * @param y
   *     Y axis direction rotation value
   */
   ...
   *
   * @param ratio
   *     Scale value: Zoom in process performed if the value is 1.0 or more; zoom out process is
   *     performed if the value is less than 1.0
   */
   ...
   *
   * @param TAG
   *     TAG output character string
   * @param glOperation
   *     Message output character string
   */
  ...
  public void loadTexture(final Bitmap texture) {
    ...
    for (int textureIndex = 0; textureIndex < 2; textureIndex++) {
      ...
      Bitmap dividedBitmap = Bitmap.createBitmap(bitmap,
